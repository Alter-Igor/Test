...
export function FormWidgetDesignerDesigner(element: HTMLElement, configuration: any, baseModel: any): FormWidgetDesignerDesignerClass {
...
export class FormWidgetDesignerDesignerClass {
    model: thisModel;
    validation: any;
