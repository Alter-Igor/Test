...
export function IBMatterWarningDesigner(element: HTMLElement, configuration: any, baseModel: any): IBMatterWarningDesignerClass {
    return new IBMatterWarningDesignerClass(element, configuration, baseModel);
} 
...
export class IBMatterWarningDesignerClass {
    model: thisModel;
    validation: any;
