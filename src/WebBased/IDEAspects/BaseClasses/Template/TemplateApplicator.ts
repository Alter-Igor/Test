...
import { IFieldPlacement, IFieldRowField, IIconRule, ICSSRule, IFieldRule, IStyleEntry, IStyleRule, INameValue, ICssClassEntry } from "./Interfaces";
...
export class TemplateApplicator {
  ...
  addCSS(cssClass: ICssClassEntry, rootDiv: HTMLDivElement, dataContextName: string, viewModel: any) {
  ...
  addStyle(style: IStyleEntry, rootDiv: HTMLDivElement, dataContextName: string, viewModel: any) {
