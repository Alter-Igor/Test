...
{  
    ...
    function createModel(actionModel: any, actionOptions: any, wfModel: any, stepModel: any) 
    {
        ...
        var defaults =
        {
            ...
            config:
            {
                ...
                instanceTag: null,          // Any instance tag required
    ...
    function dispose(actionModel: any)
    {
        // var self = actionModel;
    ...
    function getModel(actionModel: any)
    {
        // var self = actionModel;
