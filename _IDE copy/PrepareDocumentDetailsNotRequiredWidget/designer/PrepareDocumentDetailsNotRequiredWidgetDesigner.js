 ...
 * @returns {} 
 */
PrepareDocumentDetailsNotRequiredWidgetDesigner = function (element, configuration, baseModel) {
 ...
 */
PrepareDocumentDetailsNotRequiredWidgetDesigner.prototype.onDestroy = function () {
    var self = this;
};
 ...
 * into it's model
 */
PrepareDocumentDetailsNotRequiredWidgetDesigner.prototype.loadAndBind = function () {
    var self = this;
};
 ...
 */
PrepareDocumentDetailsNotRequiredWidgetDesigner.prototype.getModel = function () {
    var self = this;
    return {
