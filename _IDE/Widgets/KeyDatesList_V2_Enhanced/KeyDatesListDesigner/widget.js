...
Widgets.KeyDatesListDesigner_V2_Enhanced = function (element, configuration, base) {
    ...
    self.model =
    {
        ...
        includeRemoved: ko.observable(options.includeRemoved),
        ...
        excludePhases: ko.observableArray(options.excludePhases),
    };
    

    self.lov = {
        allExcludePhases: ko.observableArray(options.excludePhases),
        // excludePhaseSystemName: ko.observableArray(options.excludePhaseSystemName),
    };
