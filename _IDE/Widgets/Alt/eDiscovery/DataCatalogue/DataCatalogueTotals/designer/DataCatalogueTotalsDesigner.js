 ...
 * @returns {} 
 */
Widgets.Alt.eDiscovery.DataCatalogue.DataCatalogueTotalsDesigner = function(element, configuration, baseModel)
{
    var self = this;
    var defaults =
    {
 ...
 */
Widgets.Alt.eDiscovery.DataCatalogue.DataCatalogueTotalsDesigner.prototype.onDestroy = function()
{
    var self = this;
};
 ...
 * into it's model
 */
Widgets.Alt.eDiscovery.DataCatalogue.DataCatalogueTotalsDesigner.prototype.loadAndBind = function()
{
    var self = this;
};
 ...
 */
Widgets.Alt.eDiscovery.DataCatalogue.DataCatalogueTotalsDesigner.prototype.getModel = function()
{
    var self = this;
    return {
