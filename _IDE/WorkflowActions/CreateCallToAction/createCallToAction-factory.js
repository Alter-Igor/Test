(function () {
  var createModel = function (actionModel, actionOptions, wfModel, stepModel) {
    ...
    self.ui.contextTypes = [{
      ...
      value: "sharedo",
      name: "Work Item",
      varType: "/Identifier/Work Type Identifier"
    }, {
      value: "participant",
      name: "Participant",
      varType: "/Identifier/Participant Identifier"
    }, {
      value: "participantRole",
      name: "Participant Role",
      varType: "/Identifier/Participant Role Identifier"
    }];
    ...
    self.ui.contextType = ko.pureComputed(() => {
      ...
      return _.find(self.ui.contextTypes, t => t.value === contextTypeSystemName);
    });
...
//# sourceMappingURL=createCallToAction-factory.js.map