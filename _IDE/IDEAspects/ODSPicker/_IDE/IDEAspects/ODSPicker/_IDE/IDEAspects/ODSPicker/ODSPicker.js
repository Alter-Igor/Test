(self["webpackChunk"] = self["webpackChunk"] || []).push([["/_IDE/IDEAspects/ODSPicker/_IDE/IDEAspects/ODSPicker/ODSPicker"],{

/***/ "../../WebBased/IDEAspects/BaseClasses/BaseIDEAspect.ts":
/*!**************************************************************!*\
  !*** ../../WebBased/IDEAspects/BaseClasses/BaseIDEAspect.ts ***!
  \**************************************************************/
...
/* harmony import */ var _KOConverter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./KOConverter */ "../../WebBased/IDEAspects/BaseClasses/KOConverter.ts");
/* harmony import */ var _ObjectHelpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ObjectHelpers */ "../../WebBased/IDEAspects/BaseClasses/ObjectHelpers.ts");
...
var BaseIDEAspect = /*#__PURE__*/function () {
  /**
   ...
   */
  function BaseIDEAspect(componentName, loadSaveLocation, element, configuration, baseModel, defaults) {
    _classCallCheck(this, BaseIDEAspect);
    var _a;
    ...
    this.sharedoId = (_a = this.configuration._host) === null || _a === void 0 ? void 0 : _a.model.id;
   ...
   * model as required.
   */
  _createClass(BaseIDEAspect, [{
    key: "onSave",
    value: function onSave(model) {
      this.log("Saving, model passed in we need to persist to", "green", this.data);
      var dataToPersist = knockout__WEBPACK_IMPORTED_MODULE_0__.toJS(this.data);
      var currentData = (0,_ObjectHelpers__WEBPACK_IMPORTED_MODULE_2__.getNestedProperty)(model, this.LocationToSaveOrLoadData);
      if (!currentData) {
      ...
      this.log("Current data at location ".concat(this.LocationToSaveOrLoadData), "green", currentData);
      this.log("Data to persist to location ".concat(this.LocationToSaveOrLoadData, " :"), "blue", dataToPersist);
    ...
    key: "onAfterSave",
    value: function onAfterSave(model) {
    ...
    value: function log(message, color, data) {
      ...
      if ((_a = this.configuration.debug) === null || _a === void 0 ? void 0 : _a.enabled) {
        if (this.configuration.debug.logToConsole) {
          ...
          console.log("%c ".concat(this.thisComponentName, " - ").concat(message), "color:".concat(color), data);
        }
      }
    }
  }]);
  return BaseIDEAspect;
}();

/***/ }),

/***/ "../../WebBased/IDEAspects/BaseClasses/KOConverter.ts":
/*!************************************************************!*\
  !*** ../../WebBased/IDEAspects/BaseClasses/KOConverter.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "../../WebBased/IDEAspects/BaseClasses/ObjectHelpers.ts":
/*!**************************************************************!*\
  !*** ../../WebBased/IDEAspects/BaseClasses/ObjectHelpers.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _BaseClasses_BaseIDEAspect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../BaseClasses/BaseIDEAspect */ "../../WebBased/IDEAspects/BaseClasses/BaseIDEAspect.ts");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
...
// }
var OdsPicker = /*#__PURE__*/function (_BaseIDEAspect) {
  _inherits(OdsPicker, _BaseIDEAspect);
  var _super = _createSuper(OdsPicker);
  function OdsPicker(element, configuration, baseModel) {
    _classCallCheck(this, OdsPicker);
    var defaults = {
      roleConfigModels: [],
      showPreSharedo: true,
    ...
    return _super.call(this, "OdsPicker", "aspectData.odsEntityPicker", element, configuration, baseModel, defaults);
  }
  return _createClass(OdsPicker);
}(_BaseClasses_BaseIDEAspect__WEBPACK_IMPORTED_MODULE_0__.BaseIDEAspect);
...
/******/ var __webpack_exports__ = (__webpack_exec__("../../WebBased/IDEAspects/ODSPicker/ODSPicker.ts"));
/******/ }
]);